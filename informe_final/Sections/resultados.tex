...
Los entregables de este proyecto son los siguientes:
\begin{itemize}
    \item Paquete de datos para la calibración de los modelos: esto incluye las curvas ero cupón de las curvas swap camara peso.
    \item Implementación del modelo Ho-Lee en python.
    \item Implementación del modelo de valorización de la opción de prepago de python.
    \item Informe técnico de como usar este modelo y sus límites de aplicación.
\end{itemize}
